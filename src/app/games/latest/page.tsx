...
import { fetchAllLatestGames } from "@/app/lib/gameApi";
...
function LatestGamesContent() {
    ...
    useEffect(() => {
        const loadLatestGames = async () => {
            try {
                const data = await fetchAllLatestGames(currentPage);
    ...
    const updatePageUrl = (page: number) => {
        router.push(`/games/latest?page=${page}`);
    }
    ...
    return (
        <div className={styles.page}>
            ...
            <main className={styles.main}>
                ...
                {!loading && (
                    <>
                        <h2 className={styles.h2Header}>Latest Games</h2>
