...
import { fetchAllTopGames } from "@/app/lib/gameApi";
...
function TopGamesContent() {
    ...
    useEffect(() => {
        const loadTopGames = async () => {
            try {
                const data = await fetchAllTopGames(currentPage);
    ...
    const updatePageUrl = (page: number) => {
        router.push(`/games/top?page=${page}`);
    }
    ...
    return (
        <div className={styles.page}>
            ...
            <main className={styles.main}>
                ...
                {!loading && (
                    <>
                        <h2 className={styles.h2Header}>Top-Rated Games (Metacritic-based)</h2>
